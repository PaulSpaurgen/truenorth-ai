...
export default function Nav() {
  ...
  return (
    <div>
      <div className="fixed top-0 left-0 right-0 flex justify-end items-center p-4 bg-[#0E1014 ] shadow-sm z-10">
        ...
        {user && (
          <div className="flex items-center space-x-4">
            ...
            <button 
              ...
              className="bg-[#3a6f7c] text-white  rounded px-4 py-2 font-medium hover:bg-[#2a4f5c] transition-colors"
              style={{ fontFamily: 'montserrat,serif, Georgia' }}
            >
              Sign Out
            </button>
